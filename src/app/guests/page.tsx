...
import { UserCheck, ShieldCheck, MessageSquareHeart, Search, Calendar, CheckCircle } from 'lucide-react';
    ...
    <div className="bg-background">
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-headline font-bold">Featured Stays</h2>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-headline font-bold mb-12">Your Journey to Comfort</h2>
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 relative">
            ...
            <div className="relative flex flex-col items-center bg-background px-4">
              ...
              <p className="text-muted-foreground mt-2">Browse our curated collection of stays and find your perfect match.</p>
            </div>
            <div className="relative flex flex-col items-center bg-background px-4">
              <div className="bg-secondary p-4 rounded-full border mb-4">
              ...
              <p className="text-muted-foreground mt-2">Contact the host directly to confirm availability and finalize your booking details.</p>
            </div>
            <div className="relative flex flex-col items-center bg-background px-4">
              <div className="bg-secondary p-4 rounded-full border mb-4">
              ...
              <p className="text-muted-foreground mt-2">Arrive and enjoy your stay, knowing everything is arranged and verified.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-secondary py-16 md:py-24">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold font-headline">Ready to Find Your Perfect Stay?</h2>
